...
bpstop(bp)
```
Note that the explicit `bpstart`/`bpstop` are critical here: because the thread's seeds are set at the creation of the cluster, they will tick if you don't ensure that you're using a new one.
